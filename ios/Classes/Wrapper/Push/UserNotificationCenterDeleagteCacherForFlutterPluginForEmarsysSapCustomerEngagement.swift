...
public class UserNotificationCenterDeleagteCacherForFlutterPluginForEmarsysSapCustomerEngagement: NSObject, UNUserNotificationCenterDelegate {
    
    private var didReceiveCache = [[String: Any]]()
    private var willPresentCache = [[String: Any]]()
    private var openSettingsCache = [[String: Any]]()
    
    public static let instance = UserNotificationCenterDeleagteCacherForFlutterPluginForEmarsysSapCustomerEngagement()
